  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.content}>
        ...
        <Text style={[styles.warning, { color: colors.dangerAccent }]}>
          Draft v0.1 — For legal review only. Not for publication.
        </Text>

        <Text style={[styles.sectionTitle, { color: colors.text, fontFamily: LighthouseFonts.headingMedium }]}>What We Collect</Text>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text, fontFamily: LighthouseFonts.headingMedium }]}>How We Protect It</Text>
        <Text style={[styles.bodyText, { color: colors.text }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text, fontFamily: LighthouseFonts.headingMedium }]}>What We Never Do</Text>
        <Text style={[styles.bodyText, { color: colors.text }]}>
        ...
        <Text style={[styles.sectionTitle, { color: colors.text, fontFamily: LighthouseFonts.headingMedium }]}>Your Control</Text>
        <Text style={[styles.bodyText, { color: colors.text }]}>
